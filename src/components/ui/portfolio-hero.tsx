...
export default function Component({
  ...
  profileImg = "https://i.postimg.cc/y8DnKLyK/albert-dera-ILip77-Sbm-OE-unsplash.jpg",
  signature = "A",
  isDark = true,
  onToggleTheme,
  accentColor = "#C3E41D",
  ...
  return (
    <div 
      className="min-h-screen text-foreground transition-colors relative w-full"
      style={{
          ...
          <div className="relative text-center">
            <div className="mb-2">
              <BlurText
                ...
                animateBy="letters"
                direction="top"
                className="font-bold text-[80px] sm:text-[120px] md:text-[160px] lg:text-[210px] leading-[0.75] tracking-tighter uppercase justify-center whitespace-nowrap"
