      ...
      <div className="halide-body">
        ...
        <div className="viewport">
          <div className="canvas-3d" ref={canvasRef}>
            <div 
              className="layer" 
              style={{ backgroundImage: `url('${layers[0]}')`, filter: 'grayscale(1) contrast(1.2) brightness(0.5)' }} 
              ref={(el) => { if (el) layersRef.current[0] = el; }}
            ></div>
            <div 
              className="layer" 
              style={{ backgroundImage: `url('${layers[1]}')`, filter: 'grayscale(1) contrast(1.1) brightness(0.7)', opacity: 0.6, mixBlendMode: 'screen' }} 
              ref={(el) => { if (el) layersRef.current[1] = el; }}
            ></div>
            <div 
              className="layer" 
              style={{ backgroundImage: `url('${layers[2]}')`, filter: 'grayscale(1) contrast(1.3) brightness(0.8)', opacity: 0.4, mixBlendMode: 'overlay' }} 
